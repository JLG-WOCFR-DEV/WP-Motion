...
**Statut 1.1.4 :** dépôt **WP-Motion**. View Transitions morphent les éléments nommés ; Motion (MIT bundlé) chorégraphie le reste et sert de relais sans VT multi-pages. Pas de GSAP. Front inactif tant que « Activer les transitions » n’est pas coché.
