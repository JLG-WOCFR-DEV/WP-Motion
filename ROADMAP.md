...
**Statut 1.2.4 :** dépôt **WP-Motion**. Tested up to WordPress 7.1. Menu sous Réglages. Inspecteur Gutenberg dans le document parent ; barre d’admin persistante en target=_top. View Transitions morphent les éléments nommés ; Motion (MIT bundlé) chorégraphie le reste et sert de relais sans VT multi-pages. Pas de GSAP. Front inactif tant que « Activer les transitions » n’est pas coché.
