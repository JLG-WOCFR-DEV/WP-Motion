...
final class RoutesTest extends TestCase
{
    public function test_exact_beats_wildcard(): void
    {
        ...
        $checkout = WpMotion_Routes::match('single', 'checkout', $routes);
        $this->assertSame('none', $checkout['preset']);

        $article = WpMotion_Routes::match('archive', 'single', $routes);
    ...
    {
        $matched = WpMotion_Routes::match('page', 'page', [], 'slide');
